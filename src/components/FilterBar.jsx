...
const filterBarStyles = `
  .search-bar-container { background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); padding: 2.5rem 2rem; box-shadow: 0 15px 35px rgba(0,0,0,0.1); margin-top: 20px; position: relative; z-index: 10; border-radius: 16px; max-width: 1200px; margin-left: auto; margin-right: auto; transform: translateY(0); transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1); }
...
function FilterBar({ onFilterChange, initialFilters = {} }) {
  ...
  return (
    <div className="search-bar-container">
      <style dangerouslySetInnerHTML={{ __html: filterBarStyles }} />
